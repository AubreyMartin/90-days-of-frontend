...
Day 6 — Signup Form
Build a signup form with fields for: name text, email email, phone tel, DOB date, gender radio, interests checkbox, and a submit button. Use action="#" and method="post".

Day 7 — CSS 3 Ways
Take your Day 1 About Me page and style it 3 ways in 3 separate files — inline.html using style attributes, internal.html using a <style> tag, and external.html linked to a style.css file. Same visual result, 3 different methods.
